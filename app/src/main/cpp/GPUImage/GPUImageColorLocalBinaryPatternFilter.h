...
#ifndef CGPUIMAGE_ANDROID_GPUIMAGECOLORLOCALBINARYPATTERNFILTER_H
#define CGPUIMAGE_ANDROID_GPUIMAGECOLORLOCALBINARYPATTERNFILTER_H
...
// 01101101
// 76543210
class GPUImageColorLocalBinaryPatternFilter : public GPUImage3x3TextureSamplingFilter{
public:
    GPUImageColorLocalBinaryPatternFilter();
    virtual ~GPUImageColorLocalBinaryPatternFilter();
};


#endif //CGPUIMAGE_ANDROID_GPUIMAGECOLORLOCALBINARYPATTERNFILTER_H

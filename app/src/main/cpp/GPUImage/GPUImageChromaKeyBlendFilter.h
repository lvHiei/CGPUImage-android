...
#ifndef CGPUIMAGE_ANDROID_GPUIMAGECHROMAKEYBLENDFILTER_H
#define CGPUIMAGE_ANDROID_GPUIMAGECHROMAKEYBLENDFILTER_H

#include "GPUImageImageFilter.h"

/** Selectively replaces a color in the first image with the second image
 */
class GPUImageChromaKeyBlendFilter : public GPUImageImageFilter{
public:
    GPUImageChromaKeyBlendFilter();
    virtual ~GPUImageChromaKeyBlendFilter();
...
#endif //CGPUIMAGE_ANDROID_GPUIMAGECHROMAKEYBLENDFILTER_H
